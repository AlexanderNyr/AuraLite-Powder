/* @ts-self-types="./aura_lite_wasm.d.ts" */
...
export class WasmSimulation {
    ...
    constructor(width, height) {
        const ret = wasm.wasmsimulation_new(width, height);
        this.__wbg_ptr = ret;
     ...
     */
    set_particle(x, y, element_id) {
        wasm.wasmsimulation_set_particle(this.__wbg_ptr, x, y, element_id);
    }
    tick() {
        wasm.wasmsimulation_tick(this.__wbg_ptr);
    }
    /**
     * @returns {number}
     */
 ...
 */
export function create_simulation(width, height) {
    const ret = wasm.create_simulation(width, height);
    return WasmSimulation.__wrap(ret);
}
 ...
 * @returns {number}
 */
export function run_tick_test(width, height, ticks) {
    const ret = wasm.run_tick_test(width, height, ticks);
    return ret >>> 0;
}
 ...
 */
export function start_sim(canvas_id) {
    const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.start_sim(ptr0, len0);
    if (ret[1]) {
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_log_c5f366f4e64d821f: function(arg0, arg1) {
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('aura_lite_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
